...
@section('content')
    ...
    @foreach ($articles as $article)
        ...
        <a href="{{route('articles.edit', ['id' => $article->id])}}">Изменить</a> <a href="{{route('articles.destroy', ['id' => $article->id])}}" data-confirm="Вы уверены?" data-method="delete" rel="nofollow">Удалить</a>
    @endforeach
@endsection
